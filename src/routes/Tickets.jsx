...
export default function Tickets(){
  ...
  return (<div class="realticket">
    ...
    <form className="card" onSubmit={save}>
      ...
      <div><button className="ticketbtn" type="submit">{editing!=null?'Update':'Create'}</button>{editing!=null && <button type="button" className="btn ghost" onClick={()=>{setEditing(null); setForm({title:'',status:'open',desc:''})}}>Cancel</button>}</div>
    </form>
